	...
	grunt.initConfig({
		...
		copy: {
			...
			demos: {
				...
				src:
					'{node_modules/{jquery,oojs}/dist/**/*,composer.json,dist/**/*,php/**/*,node_modules/{prismjs,javascript-stringify,@fandom-frontend/design-system}/**/*}',
				dest: 'demos/',
				expand: true,
			},
			dist: {
			...
			designsystemcss: {
				flatten: true,
				src: ['node_modules/@fandom-frontend/design-system/dist/css/styles.css'],
			...
			wdsVariables: {
				src: 'node_modules/@fandom-frontend/design-system/dist/scss/wds-variables/*.scss',
